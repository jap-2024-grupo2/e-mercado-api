document.addEventListener('DOMContentLoaded', function () {
  ...
  const groupMembers = [
    ...
    },
    {
      ...
      imgSrc: `${baseURL}/web/img/kelly-profile.png`,
      altText: 'Kelly Salas'
    },
    {
      name: 'Fernanda Rigali',
      link: 'https://github.com/FerRigali',
      imgSrc: `${baseURL}/web/img/fernanda-profile.jpg`,
      altText: 'Fernanda Rigali'
    },
    {
      name: 'Ailen Albornoz',
      link: 'https://github.com/AilenAlbornoz',
      imgSrc: `${baseURL}/web/img/ailen-profile.jpeg`,
      ...
      <div class="container text-center">
        ...
        <div class="mt-3 mb-5 text-center">
          ...
          <a href="https://jovenesaprogramar.edu.uy/" target="_blank" rel="noopener noreferrer">
            <img 
              src="${baseURL}/web/img/jap-logo.png" 
